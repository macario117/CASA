...
void display ( void )   // Creamos la funcion donde se dibuja
{
	...
	//Posicion T= estandar para personajes 
		...
		glRotatef(angD, 0, 1.0, 0.0);
		glRotatef(angE, 0, 0, 1);
		glPushMatrix();
